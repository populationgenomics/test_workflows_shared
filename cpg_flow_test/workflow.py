...
def run_cpg_flow(dry_run: bool = False) -> None:
    ...
    run_workflow(
        name='tws_prime_pyramid',
        stages=[GeneratePrimes, CumulativeCalc, FilterEvens, BuildAPrimePyramid, SayHi],
        dry_run=dry_run,
    )


def validate_batch_workflow() -> None:
